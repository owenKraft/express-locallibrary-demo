...
exports.author_create_post = [
    ...
    (req,res,next) => {
        ...
        if(!errors.isEmpty()){
            // There are errros. Render form again with sanitized values / errrors messages.
            ...
            }) // Closing tags for .exec handling author already exists logic
        }
    }
]
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            function(err, results) {
                ...
                res.render('book_form', { title: 'Update Author', author: results.author, errors: errors.array() });
            });
            return;
        }
        else {
